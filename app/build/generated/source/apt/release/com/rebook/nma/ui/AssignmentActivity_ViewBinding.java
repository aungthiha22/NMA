...
public class AssignmentActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public AssignmentActivity_ViewBinding(AssignmentActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public AssignmentActivity_ViewBinding(AssignmentActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AssignmentActivity target = this.target;
