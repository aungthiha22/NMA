...
public class AnnouncementActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public AnnouncementActivity_ViewBinding(AnnouncementActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public AnnouncementActivity_ViewBinding(AnnouncementActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AnnouncementActivity target = this.target;
