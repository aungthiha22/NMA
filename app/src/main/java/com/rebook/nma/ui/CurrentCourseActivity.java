...
public class CurrentCourseActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        type = getIntent().getStringExtra(PROFILE_INTENT);
        textView_toolbar.setText(type);
        Log.e("ItemListActivity","___________"+type);
        if(type.equals("CurrentCourse")){
            textView_toolbar.setText(getResources().getString(R.string.current_course));
        }else if (type.equals("HistoryCourse")){
            textView_toolbar.setText(getResources().getString(R.string.history_course));
        }
    ...
    private void loadData(final int page) {
        if(NetService.isInternetAvailable(this)){
            if(type.equals("CurrentCourse")){
                customAdapter.setType("Current_course");
                ...
                customAdapter.setType("HistoryCourse");
                syncPostService.getCurrentCourse(tinyDB.getString(Config.STORE_TOKEN), new Callback<JsonObject>() {
                    @Override
                    public void success(JsonObject jsonObject, Response response) {
                        if (jsonObject != null) {
