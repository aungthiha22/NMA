...
import com.rebook.nma.adapter.ItemAdapter;
...
public class ItemListActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        type = getIntent().getStringExtra(INTENT_VALUE);
    ...
    private void loadData(final int page) {
        if(NetService.isInternetAvailable(this)){
            if(type.equals("Events")){
                itemAdapter.setType("Events");
                syncPostService.getEvents(1, new Callback<JsonObject>() {
                    @Override
                    public void success(JsonObject jsonObject, Response response) {
                        if (jsonObject != null) {
                            ...
                            Toast.makeText(ItemListActivity.this, "array size is "+jsonArrayData.size(), Toast.LENGTH_SHORT).show();
                ...
                itemAdapter.setType("Jobs");
                syncPostService.getJobs(1, new Callback<JsonObject>() {
                    @Override
                    public void success(JsonObject jsonObject, Response response) {
                        if (jsonObject != null) {
                            //progressBar.setVisibility(View.GONE);
